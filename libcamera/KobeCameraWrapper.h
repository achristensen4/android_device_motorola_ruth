#ifndef ANDROID_HARDWARE_KOBE_CAMERA_WRAPPER_H
#define ANDROID_HARDWARE_KOBE_CAMERA_WRAPPER_H

#include <camera/CameraHardwareInterface.h>

namespace android {

class KobeCameraWrapper : public CameraHardwareInterface {
public:
...
private:
                        KobeCameraWrapper(int CameraId);
    virtual             ~KobeCameraWrapper();
